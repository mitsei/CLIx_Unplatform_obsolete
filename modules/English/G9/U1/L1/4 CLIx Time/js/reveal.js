...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		config = {
			...
			//an disabled keyboard navigation
            keyboard: true,
	...
	function configure( options ) {
        ...
        //an changed scroll mouse to true
		if( config.mouseWheel ) {
			document.addEventListener( 'DOMMouseScroll', onDocumentMouseScroll, true ); // FF
			document.addEventListener( 'mousewheel', onDocumentMouseScroll, true );
		}
		else {
			document.removeEventListener( 'DOMMouseScroll', onDocumentMouseScroll, true ); // FF
			document.removeEventListener( 'mousewheel', onDocumentMouseScroll, true );
		}
