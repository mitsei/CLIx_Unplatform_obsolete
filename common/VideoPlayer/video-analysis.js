...
// http://blog.teamtreehouse.com/building-custom-controls-for-html5-videos
		...
		var plusFrame = function(e) {
			if (video.paused == true) {
					video.currentTime += 0.0416667;
				} 
			};
		var minusFrame = function(e) {
			if (video.paused == true) {
				video.currentTime -= 0.0416667;
			} 
		};
...
function newButts() {
	...
	// input.onchange = function () {
		...
		video.oncanplay = function() {
			...
			plusButton.addEventListener("click", plusFrame );
			
			minusButton.addEventListener("click", minusFrame);
